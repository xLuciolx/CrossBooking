 ...
 */
final class Version20190309144741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE member (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(50) NOT NULL, mail VARCHAR(100) NOT NULL, password VARCHAR(100) NOT NULL, avatar VARCHAR(255) NOT NULL, token VARCHAR(40) NOT NULL, created_at DATETIME NOT NULL, role VARCHAR(11) NOT NULL, active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
